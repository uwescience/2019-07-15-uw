...
instructor: ["Cecilia Noecker", "Dave Williams", "Meg Drouhard", "Ariel Rokem"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Ariel Rokem", "HJ Kim", "Rob Fatland", "Meg Drouhard", "Cecilia Noecker", "Jaime Schatz"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: "57041194749"  # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
